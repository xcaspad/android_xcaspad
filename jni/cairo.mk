...
LOCAL_CFLAGS    := -O2 $(LIBCAIRO_CFLAGS) -Ijni/freetype/include -Ijni/libpng -Ijni/pixman/pixman -Ijni/cairo/src -Ijni/cairo-extra -Ijni/pixman-extra -Wno-missing-field-initializers -Wno-attributes
#LOCAL_LDFLAGS   := -lz
LOCAL_SRC_FILES := $(LIBCAIRO_SRC)

LOCAL_STATIC_LIBRARIES := libpng freetype
